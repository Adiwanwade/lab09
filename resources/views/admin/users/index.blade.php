          ...
          <tbody>
            @if($users)
                ...
                <tr class="border-b dark:border-neutral-500">
                    ...
                    <td class="whitespace-nowrap px-6 py-4">{{ $user->created_at != null?  $user->created_at->diffForHumans() :''}}</td>
                    <td class="whitespace-nowrap px-6 py-4">{{ $user->updated_at !=null ? $user->updated_at->diffForHumans():'' }}</td>
                  </tr>
                @endforeach
            @endif
          </tbody>
